...
%                ix.rcvz{r}   = station r tropospheric ztd parameters
%                ix.rcvg{r}   = station r tropospheric gradient parameters
...
%            08/11/24  0.2  correct argtout description of struct ix
%-------------------------------------------------------------------------------
[ix,nx]=initindex(prm);
x=repmat(nan,nx,1);
P=zeros(nx);
