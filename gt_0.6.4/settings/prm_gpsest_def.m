...
% [note]   :
% [version]: $Revision: 21 $ $Date: 2009-05-01 11:00:40 +0900 (金, 01 5 2009) $
% [history]: 04/11/20  0.1  new
%            05/03/22  0.2  add parameter prm.tover,prm.sclkmodel,prm.rclkmodel
%                           prm.eclnprn
%            08/11/21  0.3  change default values (gt_0.6.4)
%                           support igs 30s, cod5s, igscod5s for satellite clock
%                           support itrf2005,igs05 for receiver position
%                           add parameter prm.ttol,prm.exuhsat,prm.ionwind
%-------------------------------------------------------------------------------
...
%     prm.ttol        = obs time tolerance (sec) (t-ttol/2<time<t+ttol/2)
%
%   proc#      tstart                                                 tend
%   -------------+-----------------+-----------------+--------//-------+-------
%          tover |      tunit      | tover           |                 |
...
%                       'P1'   : P1
%                       'P1C1' : P1/C1+(P1-C1)
%     prm.exuhsat     = exclude unhealthy satellites
%     prm.ionwind     = ionosphere smoothing window (points)
...
%                          'igs'     : IGS Final
%                          'igr'     : IGR Rapid
%     prm.corrf       = mesurement corrections
...
%                              0     : off
%                              1     : sat clock correction
%                              2     : sat clock + shapiro-delay correction
...
%                          ''          : use default value
%                          'gpt'       : use gpt pressure/temperature
%                          'mso'       : read msm gpv data
%                          'gso'       : read gsm gpv data
...
prm.satsrpf     = '';
prm.rcvposf     = '';
prm.pcv         = '%P\data\igs05.atx';
prm.satpcv      = '%P\data\igs05.atx';
prm.oload       = '';
prm.mpc         = '';
prm.mpp         = '';
prm.exsatrcv    = '';
...
%                         18 : fixed to IGS 30s
%                         19 : fixed to CODE 5s
%                         20 : fixed to IGS/CODE 5s (IGS final+CODE 5s interpolation)
% station parameters
...
%                         10 : fixed to IGb00
%                         11 : fixed to IGS05
%                         12 : fixed to ITRF2005
%                         13 : fixed to position read from parameter file
...
prm.rcvsig={
'ALL',   3E+1, 1E-3, 3E-1, 1E-3, 1E-3, 30, 30, 30, 1
};
...
prm.rcvprn={
'ALL',   1E+1, 1E-5, 1E-4, 1E-5, 1E-5, 0E+0, 0E+0, 0E+0, 0E+0
};
