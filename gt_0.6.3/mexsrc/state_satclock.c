/*------------------------------------------------------------------------------
% [system] : GpsTools
% [module] : state transition model - satellite clock
% [func]   : state transition model by satellite clock
...
/* state transition model - satellite clock ----------------------------------*/
extern void State_SatClock(const double *t0, const double *t, const double *x0,
					    ...
					    const mxArray *argin[])
{
	...
	State_SatClock(t0,t,x0,isat,x,Phi);
}
