...
e2={'clkf','clkb','clkfb'};
r1={'IGS Final','IGS Rapid','IGS URapid','IGS URapid(Pred)','CODE','EMR','ESA','GFZ','JPL','MIT','NGS','IGS/CODE','CODE Rapid','IGR/CODR','Broadcast'};
r2={'igs','igr','igu','igp','cod','emr','esa','gfz','jpl','mit','ngs','igscod','codr','igrcodr','brdc'};
